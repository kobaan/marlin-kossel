...
#define STRING_CONFIG_H_AUTHOR "(Kobaan)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 293.8 // get this value from auto calibrate
  ...
  #define DELTA_TOWER_ANGLE_TRIM { 0.01, 0.0, 0.0 } // get these values from auto calibrate
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -35.0     // Z probe to nozzle X offset: -left  +right
#define Y_PROBE_OFFSET_FROM_EXTRUDER -20.0     // Z probe to nozzle Y offset: -front +behind
